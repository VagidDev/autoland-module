...
public class Equipment {
    ...
    public String[] getShortEquipment() {
        return new String[] {
                ...
                "Engine type: " + this.engineType.getName(),
                "Engine volume: " + this.engineVolume,
                "Horsepower: " + this.horsepower,
                "Suspension: " + this.suspensionType.getName(),
                "Drive type: " + this.driveType.getName(),
                "Gearbox: " + this.gearboxType.getName(),
                "Speed count: " + this.speedCount,
                "Fuel: " + this.fuelType.getName(),
